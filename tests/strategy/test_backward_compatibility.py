...
from src.strategy.sync_api import Position, Quote, SyncStrategyApi
...
class TestAPIBehavior:
    ...
    @patch("src.services.md_client.MdClient")
    @patch("src.services.td_client.TdClient")
    def test_get_quote_returns_none_for_nonexistent(
        self, mock_td_client_class, mock_md_client_class
    ):
    ...
    @patch("src.services.md_client.MdClient")
    @patch("src.services.td_client.TdClient")
    def test_get_position_returns_empty_for_nonexistent(
        self, mock_td_client_class, mock_md_client_class
    ):
    ...
    @patch("src.services.md_client.MdClient")
    @patch("src.services.td_client.TdClient")
    def test_stop_can_be_called_multiple_times(
        self, mock_td_client_class, mock_md_client_class
    ):
        """测试 stop 方法可以多次调用"""
        mock_md_instance = Mock()
...
class TestExampleCodeCompatibility:
    ...
    @patch("src.services.md_client.MdClient")
    @patch("src.services.td_client.TdClient")
    def test_strategy_function_pattern(
        self, mock_td_client_class, mock_md_client_class
    ):
        """测试策略函数模式"""
        mock_md_instance = Mock()
