...
class TestEventLoopThread:
    ...
    def test_start_creates_thread(
        self, mock_td_client_class, mock_md_client_class, mock_md_client, mock_td_client
    ):
    ...
    @patch("src.services.md_client.MdClient")
    @patch("src.services.td_client.TdClient")
    def test_wait_ready_with_init_error(
    ...
    @patch("src.services.md_client.MdClient")
    @patch("src.services.td_client.TdClient")
    def test_wait_ready_timeout_on_init(
        self, mock_td_client_class, mock_md_client_class
    ):
    ...
    @patch("src.services.md_client.MdClient")
    @patch("src.services.td_client.TdClient")
    def test_wait_ready_timeout_on_login(
        self, mock_td_client_class, mock_md_client_class, mock_md_client, mock_td_client
    ):
    ...
    @patch("src.services.md_client.MdClient")
    @patch("src.services.td_client.TdClient")
    def test_wait_ready_with_login_error(
        self, mock_td_client_class, mock_md_client_class, mock_md_client, mock_td_client
    ):
        ...
        login_error_response = {
            ...
            "RspInfo": {"ErrorID": 3, "ErrorMsg": "用户名或密码错误"},
        }
