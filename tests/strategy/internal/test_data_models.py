...
from src.strategy.internal.data_models import Position, Quote
    ...
    def test_property_dual_access_equivalence(self, quote_data):
        ...
        **Validates: Requirements 6.1, 6.2**
        ...
        for field_name in fields_to_test:
            ...
            assert (
                attr_value == dict_value
            ), f"字段 {field_name} 的属性访问和字典访问返回不同的值"

            assert (
                attr_value == quote_data[field_name]
...
class TestPosition:
    ...
    def test_position_custom_values(self):
        ...
        position = Position(
            pos_long=20, pos_long_today=10, pos_long_his=10, open_price_long=3480.0
        )
    ...
    def test_position_invalid_price_nan(self):
        ...
        position_partial = Position(pos_long=10, open_price_long=3500.0, pos_short=5)
