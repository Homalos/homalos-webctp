...
async def test_validate_request_success(td_service):
    ...
    data = {
        ...
        "MsgType": msg_type,
        "RequestID": 1,
        Constant.ReqQryInstrument: {"ExchangeID": "SHFE", "InstrumentID": "cu2501"},
    }
...
async def test_call_login(td_service):
    ...
    req_data = {
        ...
        "RequestID": 1,
        Constant.ReqUserLogin: {"UserID": "test_user", "Password": "test_password"},
    }

    # Mocking _create_ctp_client to return a mock
    # mock_ctp_instance = MagicMock()
    # with patch.object(
    #     td_service, "_create_ctp_client", return_value=mock_ctp_instance
    # ) as mock_create:
...
async def test_call_qry_instrument(td_service):
    ...
    req_data = {
        ...
        "RequestID": 1,
        Constant.ReqQryInstrument: {"ExchangeID": "SHFE"},
    }
...
async def test_call_unknown_message(td_service):
    ...
    req_data = {Constant.MessageType: "UnknownType", "SomeData": {}}
